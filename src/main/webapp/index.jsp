...
<script type="text/javascript" src="${ctx}/js/jsapi.js"></script>
<script type="text/javascript" src="${ctx}/js/format+zh_CN,default,corechart.I.js"></script>
<script type="text/javascript" src="${ctx}/js/jquery.gvChart-1.0.1.min.js"></script>
<script type="text/javascript" src="${ctx}/js/jquery.ba-resize.min.js"></script>
